describe("Login and restore password. ", function() {
  ...
  it("Should proceed to the https://www.indiegogo.com page", () => {
    ...
    expect(browser.getTitle()).
        toEqual("Crowdfund Innovations & Support Entrepreneurs | Indiegogo");
  });

  it(
      "Should test that cookie consent checkbox are present and un ticked by default",
      () => {
        ...
        browser.wait(
            ExpectedConditions.elementToBeClickable(element(by.css(checkboxLabel))),
            10000);
  ...
  it("Should test that user can complete and submit the login form", () => {
    expect(element(by.xpath("//*[@id=\"vueHomepage\"]/div[1]/div[3]/div/div[1]")).
        isPresent().true);
    element(by.id("email")).sendKeys("ffnapp@ya.ru");
    element(by.id("password")).sendKeys("!1ffnApp");
    element(by.xpath(
        "//*[@id=\"vueHomepage\"]/div[1]/div[2]/div/div[1]/div[2]/div/form/div[3]/button")).
        click();
  });

  it(
      "Should test that user logged in an user name is shown in the top right corner of the screen",
      () => {
        expect(
            element(by.xpath("//*[@id=\"vueHomepage\"]/div[1]/div[3]/div/div[1]")).
                isPresent().false);
        expect(element(by.xpath(
            "//*[@id=\"iggAppLayout\"]/div/div/div[1]/div/nav/div/div[2]/div/div[4]/a/span")).
            getText()).toEqual("ffnapp");
      });
  ...
  it("Should test that user can perform the log out", () => {
    element(by.xpath(
        ...
        click();
    element(by.xpath(
        "//*[@id=\"iggAppLayout\"]/div/div/div[1]/div/nav/div/div[2]/div/div[5]/a[5]")).
        click();
    expect(element(by.xpath(
        "//*[@id=\"iggAppLayout\"]/div/div/div[1]/div/nav/div/div[2]/div/div[4]/a/span")).
        isPresent().false);
  ...
  it(
      "Should test that restore password link is present and user can proceed to the restore password form",
      () => {
        element(by.css(".layoutHeader-logIn")).click();
  ...
  it("Should test that user can perform the login from the second login form",
      () => {
        element(by.xpath(
            "/html/body/div[2]/div/div/div[3]/div/div/div[3]/form/input[3]")).
            sendKeys("ffnapp@ya.ru");
        element(by.xpath(
            "/html/body/div[2]/div/div/div[3]/div/div/div[3]/form/input[4]")).
            sendKeys("!1ffnApp");
        element(by.xpath(
            "/html/body/div[2]/div/div/div[3]/div/div/div[3]/form/input[5]")).
            click();
        expect(element(by.xpath(
            "//*[@id=\"iggAppLayout\"]/div/div/div[1]/div/nav/div/div[2]/div/div[4]/a/span")).
            getText()).toEqual("ffnapp");
